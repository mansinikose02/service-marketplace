    ...
    <Layout>
      <div className="fade-in">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl p-6 mb-6 shadow-lg">
          <h1 className="text-2xl font-bold mb-1">Find Your Next Project</h1>
          <p className="text-indigo-200 text-sm">Browse open requirements from clients looking for your expertise</p>
        </div>

        {/* Filter bar */}
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-sm p-4 mb-5">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div>
              ...
              <select
                id="categoryFilter" value={selectedCategory}
            ...
            <div>
              ...
              <input
                id="maxBudget" type="number" value={maxBudget}
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  <span className="inline-flex mt-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-800">
                    {req.category}
                  </span>
