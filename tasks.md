...
- [ ] 2. Server dependencies and project structure
...
- [ ] 3. Server environment and database config
  - [ ] 3.1 Create `server/config/env.js`
  ...
  - [ ] 3.2 Create `server/config/db.js`
...
- [ ] 4. User model
  - [ ] 4.1 Create `server/models/User.js` with the full Mongoose schema
  ...
  - [ ] 4.2 Add pre-save bcryptjs hook to `User.js`
